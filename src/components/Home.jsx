...
function Home() {
  return (
    <div className="h-screen flex items-end bg-red w-[100%] flex-col justify-end items-center">
      ...
      <div className="flex flex-col items-center mt-52 absolute top-0  text-white">
